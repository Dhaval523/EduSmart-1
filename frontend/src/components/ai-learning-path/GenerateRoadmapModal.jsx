...
export const GenerateRoadmapModal = ({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => (!open ? onClose?.() : null)}>
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-hidden bg-slate-50 p-0">
        <div className="flex flex-col max-h-[85vh]">
          ...
          <div className="flex items-center justify-end gap-3 border-t border-slate-200 bg-white px-6 py-4">
            ...
            <button
              ...
              onClick={onSubmit}
              disabled={isLoading}
              className="inline-flex items-center gap-2 rounded-2xl bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800 disabled:opacity-70"
            >
