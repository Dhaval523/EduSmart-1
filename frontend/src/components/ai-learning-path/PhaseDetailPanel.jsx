...
export const PhaseDetailPanel = ({
  ...
  if (!phase) {
    return (
      <div className="h-full rounded-3xl border border-dashed border-gray-200 bg-[#F7F7FB] p-6 text-sm text-[#6B7280]">
      ...
      <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <h3 className="mt-1 text-xl font-extrabold tracking-tight text-[#1F2937]">
