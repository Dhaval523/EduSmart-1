    ...
    <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm flex flex-col h-full">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-base font-extrabold text-[#1F2937]">Previous learning paths</h3>
        </div>
        {onRefresh ? (
          <button
            type="button"
      ...
      <button
        type="button"
        onClick={onGenerate}
        className="mt-4 inline-flex items-center justify-center gap-2 rounded-2xl bg-[#6C5DD3] px-4 py-3 text-sm font-semibold text-white hover:bg-[#5B4FC4] transition-colors"
      >
