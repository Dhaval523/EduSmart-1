      ...
      <div className="animate-pulse space-y-6">
        <div className="flex items-center justify-between gap-4">
          <div className="space-y-2">
            ...
            <div className="h-7 w-72 rounded-2xl bg-slate-200" />
          </div>
          <div className="h-9 w-28 rounded-2xl bg-yellow-200" />
        </div>
        ...
        <div className="space-y-4">
          {[...Array(3)].map((_, idx) => (
            <div key={idx} className="relative rounded-2xl border border-slate-200 p-4">
              <div className="mb-3 flex items-center gap-3">
                <div className="h-8 w-8 rounded-2xl bg-yellow-200" />
