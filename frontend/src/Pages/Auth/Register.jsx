...
import { useGetUserHook, useRegisterHook } from '@/hooks/User.hook'
    ...
    <div className='page-bg flex items-center justify-center py-12'>
      <div className='w-full max-w-md card'>
        <div className='text-center mb-8'>
          ...
          <p className='text-sm text-[#51607b] mt-1'>Join us and start your journey</p>
        </div>
        ...
        <p className='text-sm text-center text-[#51607b] mt-6'>
          ...
          <Link to='/login' className='text-[#0ea5a4] font-medium hover:underline'>
            Login
          </Link>
        </p>
      </div>
